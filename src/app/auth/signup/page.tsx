...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fcfbf7] px-4">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-gray-900 mb-4">Create an account</h1>
        <div>
          <input
            {...register("fullName")}
            type="text"
        ...
        <p className="text-center text-gray-600 text-base mt-2">
          ...
          <a href="#" className="underline font-medium text-gray-900">Terms of Service</a>
        </p>
        <p className="text-center text-gray-700 text-lg mt-2">
          Already have an account?{' '}
          <a href="/auth/login" className="font-bold text-green-900 hover:underline">Sign in</a>
        </p>
      </form>
    </div>
  );
